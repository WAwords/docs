    ...
    nav: [
      { text: "首页", link: "/" },
      {
        ...
        items: [
          ...
          { text: "JavaScript 对象常用方法", link: "/frontend/javascript/object-methods" },
          { text: "JavaScript 字符串常用方法", link: "/frontend/javascript/string-methods" },
            { text: "JavaScript 日期时间处理", link: "/frontend/javascript/date-time" },
            { text: "JavaScript 函数式编程入门", link: "/frontend/javascript/functional-programming" },
          { text: "fetch API 实用指南", link: "/frontend/javascript/fetch-api" },
          ...
          { text: "Web 性能核心指标", link: "/frontend/web-performance-metrics" },
            { text: "前端性能监控与分析", link: "/frontend/performance-monitoring" },
      ...
      "/tools/git/": {
        ...
        items: [
          ...
          { text: "Node.js 常见问题排查", link: "/tools/nodejs/troubleshooting" },
      ...
      "/frontend/javascript/": [
        {
          ...
          items: [
            ...
            { text: "对象常用方法", link: "/frontend/javascript/object-methods" },
            { text: "字符串常用方法", link: "/frontend/javascript/string-methods" },
            { text: "日期时间处理", link: "/frontend/javascript/date-time" },
      ...
      "/frontend/css/": [
        {
          ...
          items: [
            ...
            { text: "Grid 布局指南", link: "/frontend/css/grid" },
          ],
        },
      ],
      "/frontend/webpack/": [
      ...
      "/frontend/": [
        {
          ...
          items: [
            ...
            { text: "Web 性能核心指标", link: "/frontend/web-performance-metrics" },
            { text: "性能监控与分析", link: "/frontend/performance-monitoring" },
      ...
      "/tools/nodejs/": [
        {
          ...
          items: [
            ...
            { text: "常见问题排查", link: "/tools/nodejs/troubleshooting" },
          ],
        },
      ],
      "/tools/npmScripts/": [
